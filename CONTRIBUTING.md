...
If an issue doesn't exist, you can open a new issue using a relevant [issue form](https://github.com/Drugsosos/VideoBot/issues/new/choose). 

#### Solve an issue

View the [existing issues](https://github.com/Drugsosos/VideoBot/issues) to find something interesting to you. 

In general, issues are not assigned to anyone

> Except for newcommers issues, they'll be assined on [Drugsosos](https://github.com/Drugsosos)
...
2. Install or update to **Python v3.10**. For more information, see [the install guide](https://github.com/Drugsosos/VideoBot/wiki/Install-guide#installation).

4. Create a working branch out of 'develop' and start with your changes!
...
Once your PR is merged, your contributions will be publicly visible on the [VideoBot](https://github.com/Drugsosos/VideoBot).
